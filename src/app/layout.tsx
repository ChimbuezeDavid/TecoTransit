  ...
  return (
    <html lang="en" className="h-full" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext x='0' y='80' font-size='90' font-weight='bold' fill='yellow' font-family='sans-serif'%3ETeco%3C/text%3E%3C/svg%3E" type="image/svg+xml" />

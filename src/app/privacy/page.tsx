    ...
    <div className="container mx-auto px-4 py-8 sm:py-12">
      <Card className="max-w-3xl mx-auto shadow-lg">
        ...
        <CardContent className="space-y-8 text-base text-muted-foreground">
            <p className="leading-relaxed">Welcome to TecoTransit. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at tecotransit@gmail.com.</p>
            ...
            <div className="space-y-4">
                ...
                <p className="leading-relaxed">If you have questions or comments about this policy, you may email us at tecotransit@gmail.com or by post to:</p>
